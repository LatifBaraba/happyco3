...
<div class="login-box">
  <div class="login-logo">
    <a href="<?php echo WEB_URL; ?>dasboard/home"><b>Admin</b> KPR Hijrah</a>
  </div>
  <!-- /.login-logo -->
  <div class="card">
    <div class="card-body login-card-body">
      ...
      <p class="mb-1">
        <a href="<?php echo WEB_URL; ?>auth/forgotpassword">I forgot my password</a>
      </p>
      <p class="mb-0">
        <a href="<?php echo WEB_URL; ?>auth/register" class="text-center">Register a new membership</a>
      </p>
    </div>
    <!-- /.login-card-body -->
  </div>
