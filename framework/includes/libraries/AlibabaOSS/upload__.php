<?php
	...
	// AWS Info
	$bucketName = 'akhirbucket';
	$IAM_KEY = 'LTAI4FiLiiCr9HoP23gxj477';
	$IAM_SECRET = 'sxW9RrMkJ4dMsa6ZBOH3DkVY59rlfE';
	// Connect to AWS
	try {
		// You may need to change the region. It will say in the URL when the bucket is open
		// and on creation.
		$s3 = OssClient::factory(
			array(
				'credentials' => array(
					'key' => $IAM_KEY,
					'secret' => $IAM_SECRET
	...
	$pathInS3 = $bucketName .'http://oss-ap-southeast-5.aliyuncs.com'.$keyName;
	// Add it to S3
	try {
		// Uploaded:
